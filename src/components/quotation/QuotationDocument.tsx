  ...
  return (
    <Document>
      ...
      <Page size="A4" style={s.coverPage}>
        ...
        <View style={s.ct}>
          <Text style={s.ln}>
            <Text style={s.b}>Date:</Text> {q.date || "-"}
          </Text>
          <Text style={s.ln}>
            <Text style={s.b}>To:</Text> {q.to || "-"}
          </Text>
          <Text style={s.ln}>
            <Text style={s.b}>Attn:</Text> {q.attn || "-"}
          </Text>
          <Text style={s.ln}>
            <Text style={s.b}>Project:</Text> {q.project || "-"}
          </Text>
          <Text style={s.ln}>
            <Text style={s.b}>Subject:</Text> {subject}
          </Text>
      ...
      <Page size="A4" style={s.annexPage} wrap>
        ...
        <View style={s.ct}>
          <Text style={s.cuh} minPresenceAhead={40}>
            ANNEXURE-1:
          </Text>
          ...
          <Text style={[s.uh, { marginTop: 12 }]} minPresenceAhead={30}>
            EXCLUSIONS:
          </Text>
          ...
          <Text style={[s.cuh, { marginTop: 16 }]} minPresenceAhead={55}>
            ANNEXURE-2:
          </Text>
          ...
          <Text style={[s.cuh, { marginTop: 16 }]} minPresenceAhead={40}>
            ANNEXURE-3:
          </Text>
          <Text style={s.uh}>TERMS AND CONDITIONS</Text>

          <Text style={[s.uh, { marginTop: 20 }]} minPresenceAhead={30}>
            PAYMENT TERMS:
          </Text>
          ...
          <Text style={[s.uh, { marginTop: 20 }]} minPresenceAhead={20}>
            VALIDITY:
          </Text>
