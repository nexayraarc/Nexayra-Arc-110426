  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        {[
          { label: "Contract", value: fmtAED(project.contractValue || 0), icon: DollarSign, color: "", text: "text-white", brand: true },
          ...
          <div key={k.label}
            className={`${(k as any).brand ? "bg-brand-navy" : `bg-gradient-to-br ${k.color}`} ${k.text} rounded-2xl p-4 shadow-sm animate-fade-in-up`}
